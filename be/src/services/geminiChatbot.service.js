...
- Chuyên: Điện thoại, Laptop, Tablet, Màn hình, Phụ kiện, TV
...
`;
  ...
  getFallbackResponse(userMessage) {
    ...
    if (lowerMessage.includes("áo") || lowerMessage.includes("shirt")) {
      return {
        response:
          "👕 Chúng tôi có nhiều Loại lapTop như Macbook, Dell, MSI... Bạn muốn xem loại nào?",
        suggestions: ["Macbook", "MSI", "ACER", "Xem tất cả loại laptop"],
        intent: "product_search",
      };
    }
